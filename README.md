...
Please note this has only been tested using the Photon and the sensors included in the Particle Maker kit. A video will be posted shortly to show the particular set up that worked for this code.
